...
export function MemberFinancialAlert({
  ...
  return (
    <div
      className={`glass-card border ${toneClass.border} ${toneClass.bg} px-5 py-5 transition`}
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          {description && (
            <p className="mt-1 text-sm text-base-muted/90">{description}</p>
          )}
        </div>
      ...
      <div className="mt-4">
        {isLoading ? (
          <div className="animate-pulse text-sm text-base-muted">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border border-white/20 bg-white/5 px-4 py-3 text-sm">
              ...
              <p className={`mt-1 text-2xl font-semibold ${toneClass.accent}`}>
                {snapshot.status}
              </p>
            ...
            <div className="rounded-xl border border-white/20 bg-white/5 px-4 py-3 text-sm">
              ...
              <span className="text-xs text-base-muted">
                Total abonado: {snapshot.totals.paid}
              </span>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/3 px-4 py-3 text-sm">
              ...
              <span className="text-xs text-base-muted">
                Acceso limitado hasta regularizar
              </span>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/3 px-4 py-3 text-sm">
              <p className="text-xs uppercase tracking-widest text-base-muted">
